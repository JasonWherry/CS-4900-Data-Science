""" Author: Jason Wherry	Date: 2/10/2020		To Run: python3 clusterPart2.py
...
def findMinAvgDiff(cluster, clustDict, clustNum):
	...
	return(closest(meanNPList, AVGmeanNP))

	# Could I make this fucntion recursive? 
	# The base case would be: if prevCluster=newCluster, then return cluster and end

findMinAvgDiff(clust1, clust10, 1)
findMinAvgDiff(clust2, clust20, 2)
findMinAvgDiff(clust3, clust30, 3) 
